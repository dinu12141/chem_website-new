          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-400">
                Manage customer support messages, classes, Telegram channels, and video lessons
              </p>
            </div>
            <Button 
              onClick={fetchData}
        ...
        <div className="mb-8">
          <div className="flex flex-wrap gap-2">
            <Button
              ...
              className={activeTab === 'messages' ? 'bg-yellow-600 hover:bg-yellow-700' : 'border-gray-600 text-gray-300'}
            >
            ...
            <Button
              ...
              className={activeTab === 'classes' ? 'bg-yellow-600 hover:bg-yellow-700' : 'border-gray-600 text-gray-300'}
            >
            ...
            <Button
              ...
              className={activeTab === 'telegram' ? 'bg-yellow-600 hover:bg-yellow-700' : 'border-gray-600 text-gray-300'}
            >
            ...
            <Button
              ...
              className={activeTab === 'videos' ? 'bg-yellow-600 hover:bg-yellow-700' : 'border-gray-600 text-gray-300'}
            >
